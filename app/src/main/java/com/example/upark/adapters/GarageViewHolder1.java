...
public class GarageViewHolder1 extends GarageViewHolder {
    private final String TAG = this.getClass().getSimpleName();
    private final SearchedGarageCardBinding binding;
    private final View view;

    public GarageViewHolder1(@NonNull SearchedGarageCardBinding binding) {
        super(binding.getRoot());
        this.binding = binding;
        view = null;
    }
    public GarageViewHolder1(@NonNull View itemView) {
        super(itemView);
        this.view = itemView;
        binding = null;
    }
